...
mod tests {
    ...
    fn test_format_distance_vec() {
        let distances = vec![
            vec![Distance::Reachable(0), Distance::Reachable(1), Distance::Reachable(2)],
            vec![Distance::Reachable(1), Distance::Unreachable, Distance::Unreachable],
            vec![Distance::Reachable(2), Distance::Unreachable, Distance::Unreachable],
        ];
